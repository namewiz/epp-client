...
- `dumpDomains({ transactionId, timeout })` - fetch info payloads for all domains under the authenticated user. The demo script illustrates writing the results to `data/domains-YYMMDD-HHMM.json`.
